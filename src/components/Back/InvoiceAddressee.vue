  ...
  <div class="background">
    ...
    <Modal v-model="showModal.receiptInfoAdd" width="500" :mask-closable="false">
      ...
      <div class="universal-modal-label-14px hide-star-symbol">
        ...
        >
          ...
          <FormItem label="验证码" prop="code">
            <Input type="text" v-model="formReceipt.code" placeholder="请输入验证码" style="width:107px;"></Input>
            <Button
              type="primary"
      ...
      <div class="v_box">
        ...
        <p>
          1、网络异常可能会造成短信丢失，请
          <span @click="getVerificationCode('msg')">重新获取</span>或
          <span @click="getVerificationCode('voice')">接受语音验证码</span>。
        </p>
        <p>
          2、如果手机已丢失或停机，请
          <a href="https://www.xrcloud.net/work" target="_blank">提交工单</a>或
          <a
            class="box_a"
            target="_blank"
        ...
        <Form ref="formInvoice" :model="formInvoice" :rules="ruleInvoice" :label-width="100">
          ...
          <div v-if="formInvoice.invoiceSelect == 'normal'">
            ...
            <FormItem prop="rise" label="发票抬头">
              <Input
                type="text"
                v-model="formInvoice.rise"
                placeholder="您公司营业执照上的全称"
                style="width:300px;"
              ></Input>
            </FormItem>
          ...
          <div v-if="formInvoice.invoiceSelect == 'personal'">
            ...
            <FormItem prop="landline" label="注册电话">
              <Input
                type="text"
                v-model="formInvoice.areaCode"
                placeholder="区号"
                style="width:90px;"
              ></Input>——
              <Input type="text" v-model="formInvoice.phone" placeholder="电话号" style="width:180px;"></Input>
            </FormItem>
            <FormItem prop="bankName" label="开户银行">
              <Input
                type="text"
                v-model="formInvoice.bankName"
                placeholder="请精确到支行，如‘招商银行重庆靖城路支行’"
                style="width:300px;"
              ></Input>
            </FormItem>
            <FormItem prop="bankNum" label="银行账户">
              <Input
                type="text"
                v-model="formInvoice.bankNum"
                placeholder="您公司开户许可证上的银行账号"
                style="width:300px;"
              ></Input>
            </FormItem>
          </div>
