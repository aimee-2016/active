        ...
        <div class="black">
            ...
            <div>
                ...
                <div style="margin-top:10px;" v-else>
                    <Input class="dp-area" type="textarea" v-model="blackValue" placeholder="请以英文半角分号‘;’分隔"> </Input>
                </div>
            </div>
        </div>
        <div class="black">
            ...
            <div>
                ...
                <div style="margin-top:10px;" v-else>
                    <Input class="dp-area" type="textarea" v-model="whitValue" placeholder="请以英文半角分号‘;’分隔"> </Input>
                </div>
            </div>
        </div>
    </div>    
