            ...
            <span class="title">云安全 / DDoS高防IP / <span>业务管理</span></span>
             <div id="content">
                ...
                <div class="st-box" v-if="current == 1">
                    ...
                    <p>CNAME：{{cname}}</p>
                    <p style="margin-bottom: 40px;">若您是在新睿云购买的域名，请前往<a href="https://domain.xrcloud.net/xrdomain/domainGroup" target="_blank" style="color:#2A99F2;cursor:pointer;">域名解析</a></p>
