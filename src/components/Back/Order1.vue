      ...
      <div class="content">
        ...
        <div class="order_text"
          ...
          <div>
            ...
            <p v-if="routerName == '新建云服务器'" class="o-fm">当前黑龙江、内蒙古、山东三地暂时无法提供域名备案，您可以选择邻省进行备案</p>
...
export default {
  ...
  methods: {
    ...
    getPrice(){
      axios.get('information/getPrice.do',{
        params:{
          orders:this.orderInfo.orderId.substring(
              0,
              this.orderInfo.orderId.length - 1
            ),
          ticket:this.couponInfo.selectTicket
  ...
  computed: {
    ...
    isTitleHide(){
      if(this.routerName == '新建云服务器' || this.routerName =='续费' || this.routerName == '新建云硬盘' || this.routerName == '磁盘升级' || this.routerName == '新建GPU云服务器' || this.routerName == '系统盘扩容'){
        return true;
      }else{
        return false;
      }
