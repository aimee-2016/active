  ...
  export default {
    metaInfo: {
      ...
      meta: [{                 // set meta
        ...
        {                 // set meta
          name: 'description',
          content: '新睿云的弹性伸缩服务，可以根据你的业务需求，设置创建伸缩策略告警伸缩，对云服务器计算资源进行定时伸缩自动化管理，达到高效率、节约成本、及时容错的目的。'
        }]
    },
    data() {
      return {
        logo: {
          ...
          title: '弹性伸缩',
          desc: '可以根据你的业务需求，设置创建伸缩策略告警伸缩，对云服务器计算资源进行定时伸缩自动化管理，达到高效率、节约成本、及时容错的目的。 ',
        ...
        features: [
          {
            ...
            title: '告警伸缩',
            desc: '根据云服务器指标情况调整业务部署，那么您可以自定义告警触发策略，当业务负载使得指标（包括CPU利用率、内存利用率等）到达阈值时，该策略将帮助您自动增加或减少云服务器 实例数量。'
          },
          {
            img: 'icon-NVIDATeslaGPU',
            title: '定时伸缩',
            desc: '设置定时任务，对您的设备扩展活动进行规划，您可以使用此功能定时及周期性地自动增加或减少云服务器实例，支持按天/周/月重复操作，从而灵活应对业务负载变化，提高设备利用率，节省部署和实例成本。'
          },
          {
            img: 'icon-gaoxingnengcunchu',
            title: '替换不健康云服务器',
            desc: '弹性伸缩自动检测实例的健康状况，一旦发现异常，即自动复制出健康的实例，以替换状态异常的云服务器实例，确保您的应用程序获得预期的计算容量，为您的业务保驾护航。 '
          },
          {
            img: 'icon-gaoxingnengwangluo',
            title: '自带配置负载均衡',
            desc: '通过告警策略新增的云服务器实例还可直接关联已有负载均衡，以使伸缩组新增的实例承担分发流量，从而提高服务可用性。 '
          },
          {
            img: 'icon-GPUDirect',
            title: '伸缩活动记录',
            desc: '弹性伸缩会根据您设定的伸缩策略自动增加或减少云服务器实例，如果您想了解伸缩策略已执行情况，使用该功能查看即可，该功能可帮助您掌握弹性伸缩已执行的活动情况。'
          },
        ],
        stageInfo: {
          stages: [
        ...
        advantages: [
          {
            img: 'icon-linghuo',
            title: '自由灵活',
            desc: '自动监控、智能调度您的业务所需云服务器资源；多种监控方案选择、支持告警、定时、自定义等多种伸缩方式。'
          },
          {
            img: 'icon-gaokeyong',
            title: '高可用',
          ...
          },
          {
            img: 'icon-gaoanquan',
            title: '自动化运维',
            desc: '自动实现伸缩，无需人工干预。弹性伸缩可以根据业务动态实时自动创建和释放云服务器，帮助您以最合适的实例数量应对业务状况。'
          },
        ],
        recommendations: [
          {
