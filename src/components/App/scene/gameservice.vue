...
<script type="text/ecmascript-6">
  ...
  export default {
    metaInfo: {
      title: '云游戏平台 - 大型游戏开发环境 - 3d游戏测试工具 - 应用场景 - 新睿云', // set a title
      meta: [{                 // set meta
        name: 'keywords',
        content: '云游戏,云游戏平台,3d游戏测试,3d游戏测试工具,大型游戏开发环境'
      },
        {                 // set meta
          name: 'description',
          content: '新睿云游戏服务革新您的开发平台，您能够以更快的速度完成大型3D游戏的开发测试工作。凭借超高的运算速度与传输速度，加速您的大规模图形演算与视频处理能力。'
        }]
    },
    components: {
      VueQArt
    ...
    created() {
      this.setData('gameservice')
      this.getRegion('gameservice')
    },
    methods: {
      init() {
