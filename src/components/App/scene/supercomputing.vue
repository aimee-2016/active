...
<script type="text/ecmascript-6">
  ...
  export default {
    metaInfo: {
      title: '超级运算 - 深度学习模型训练与推断 - 应用场景 - 新睿云 ', // set a title
      meta: [{                 // set meta
        name: 'keywords',
        content: '超级运算,深度学习模型训练,深度学习推断'
      },
        {                 // set meta
          name: 'description',
          content: '新睿云深度学习平台基于强劲的 GPU 计算资源，在配置Tesla P40和Tesla P100的基础上。各个行业都可以帮助您成倍提高计算和工作效率。比如在计算机视觉与图像处理领域，图像处理与计算机视觉算法是计算密集型算法。'
        }]
    },
    components: {
      VueQArt
    ...
    created() {
      this.setData('supercomputing')
      this.getRegion('supercomputing')
    },
    methods: {
      init() {
