...
<script type="text/ecmascript-6">
  ...
  export default {
    metaInfo: {
      title: '3d设计 - 3d云渲染 - 应用场景 - 新睿云', // set a title
      meta: [{                 // set meta
        name: 'keywords',
        content: '3d设计,3d渲染,3d云渲染'
      },
        {                 // set meta
          name: 'description',
          content: '借助新睿云3D设计，以远低于自购设备的价格来获取更为稳定优质的计算资源能力提升，成倍提高您的设计工作效率和渲染效率。'
        }]
    },
    components: {
      VueQArt
    ...
    created() {
      this.setData('graphicdesign')
      this.getRegion('graphicdesign')
    },
    methods: {
      init() {
