            ...
            <div v-for="(cfg,index1) in item.configGroup" class="config" :class="{gpu: scene == '游戏服务'||scene == '图形设计'|| scene == '人工智能'|| scene == '超级运算'}">
              ...
              <div class="cf-body">
                ...
                <div class="cf-footer">
                  ...
                  <Button type="primary" v-if="(scene == '游戏服务'||scene == '图形设计'|| scene == '人工智能'|| scene == '超级运算')&& index1 == 1" :disabled="true">已售罄</Button>
...
<script type="text/ecmascript-6">
  ...
  export default {
    metaInfo: {
      title: '深度学习框架 - Jupyter notebook开发环境 - 数据科学工具包 - 应用场景 - 新睿云', // set a title
      meta: [{                 // set meta
        name: 'keywords',
        content: '深度学习框架,jupyter,数据科学工具包'
      },
        {                 // set meta
          name: 'description',
          content: '新睿云人工智能平台基于强劲的GPU计算资源，在配置Tesla P40和Tesla P100直通模式的基础上，搭载 Caffe、CNTK、PyTorch和Keras等多个主流深度学习框架，同时集成 Jupyter notebook开发环境及numpy、scipy、pandas等众多数据科学工具包。'
        }]
    },
    components: {
      VueQArt
    ...
    data() {
      ...
      return {
        ...
        currentSceneGroup: [
          ...
          {
            currentScene: '游戏服务',
            disc: '借助新睿云游戏服务革新您的开发平台，您能够以更快的速度完成大型3D游戏的开发测试工作。凭借超高的运算速度与传输速度，加速您的大规模图形演算与视频处理能力；搭配新睿云云服务器、对象存储与云数据库使用，完成从生产研发到部署测试的全流程工作。并且，新睿云游戏服务提供按需付费方式，以小时级为单位来获取工业级GPU计算服务能力。',
            configGroup: [
              {
                title: '初创型业务网站（3天）',
                configs: [
