  ...
  <div class="buy-login-info">
    <div class="wrap">
      <div class="content">
        ...
        <div class="specification-item" v-if="loginInfo.setType==='customSet'">
          <div class="item-label">
            <span>实例名称</span>
          </div>
          <div class="item-text">
            <Input v-model="loginInfo.serverName" placeholder="请输入数据库名" style="width: 200px"></Input>
          </div>
        </div>
        ...
        <div
          ...
          v-if="loginInfo.setType==='customSet'"
        >
          <div class="item-label">
            <span>登录方式</span>
          </div>
