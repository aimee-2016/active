  ...
  <div>
    <div class="banner">
      <img style="position: absolute;bottom: 0px;z-index: -1"
           src="../../../assets/img/active/newNodes/banner_3.png" alt="banner">
      <img style="position: absolute;top: 7%;left: 7%;"
           src="../../../assets/img/active/newNodes/circle_1.png" alt="banner">
      <div style="width:1200px;margin:0px auto;padding-top: 12%;position: relative">
        <p style="position: relative">北京一区盛大开服<img style="position: absolute;left: -2%;top: -45%;" src="../../../assets/img/active/newNodes/text.png" alt="新睿云"/></p>
        ...
        <transition name="list">
          <img v-if="img_1" style="position:absolute;left: 45%; top: 30%;z-index: -2;"
               src="../../../assets/img/active/newNodes/banner_4.png" alt="banner">
        </transition>
      </div>
    ...
    <div style="position: relative;">
      <div style="background: rgba(247,163,125,0.5)">
        <div class="center">
          <div class="process">
            <img style="position: absolute;right: 0; top: -34px;" src="../../../assets/img/active/newNodes/shadow1.png" alt="icon"/>
            <img style="position: absolute;left: 102%" src="../../../assets/img/active/newNodes/icon_1.png" alt="icon"/>
            <h2 style="margin-bottom: 20px">活动流程</h2>
            <p>活动时间：2018.4.16-2018.5.16</p>
            <div class="items">
              <dl>
                <dt v-if="isLogin==1"><img src="../../../assets/img/active/newNodes/dl.png" alt="icon"></dt>
              ...
              <dl>
                <dt v-if="companyauth==0||personalauth==0"><img src="../../../assets/img/active/newNodes/zc.png" alt="icon">
                </dt>
              ...
              <dl>
                ...
                <dt v-else><img src="../../../assets/img/active/newNodes/lq.png" alt="icon"></dt>
      ...
      <div style="background: rgba(255,248,246,1)">
        <div class="center">
          <div class="active_one">
            <img style="position: absolute;right: 102%" src="../../../assets/img/active/newNodes/icon_2.png" alt="icon"/>
            <h2 style="margin-bottom: 20px">限时<img style="position: relative;top: 32px;margin: 0 5px"
                                                   src="../../../assets/img/active/newNodes/threez.png" alt="3">折秒杀</h2>
              ...
              <div v-for="(item,index) in config_one" class="content">
                ...
                <div class="info">
                  ...
                  <div class="info_right">
                    ...
                    <div class="price">
                      <img src="../../../assets/img/active/newNodes/tag.png" alt="三折">
        ...
        <div class="center">
          <div class="active_two">
            <img style="position: absolute;left: 110%;top:20%;" src="../../../assets/img/active/newNodes/icon_3.png" alt="icon"/>
            <img style="position: absolute;right: 105%;bottom: 15%" src="../../../assets/img/active/newNodes/icon_4.png" alt="icon"/>
                ...
                <div class="info">
                  <div class="info_left">
                    <div class="info_left_top">
                      <ul>
                        <li><img src="../../../assets/img/active/newNodes/cpu.png" alt="icon"/>{{ item.cpu }}</li>
                        <li><img src="../../../assets/img/active/newNodes/memory.png" alt="icon"/>{{ item.memory }}</li>
                        <li><img src="../../../assets/img/active/newNodes/disc.png" alt="icon"/>{{ item.disk }}</li>
                        <li><img src="../../../assets/img/active/newNodes/bandWidth.png" alt="icon"/>{{ item.bandWidth}}</li>
                      </ul>
                    </div>
      ...
      <div style="background:rgba(246,148,119,1);">
        <div class="center">
          <div class="rules">
            <h2 class="h">活动规则</h2>
            <dl>
...
<style rel="stylesheet/less" lang="less" scoped>
  .banner {
    ...
    .banner_text {
      ...
      width: 1200px;
      background: url('../../../assets/img/active/newNodes/textBanner1.png') -18px no-repeat;
        ...
        dl {
          ...
          dd {
            ...
            i {
              ...
              top: 21px;
              &.select {
                border-right: 1px solid #F2776C;
                border-bottom: 1px solid #F2776C;
              }
            }
          }
        }
      ...
      .config_one {
        ...
        .content {
          ...
          .title {
            height: 72px;
            text-align: center;
            background: url('../../../assets/img/active/newNodes/hostBanner.png') 430px no-repeat, linear-gradient(90deg, rgba(244, 130, 116, 1), rgba(243, 111, 104, 1));
        ...
        config_one: [
          {
            ...
            node: '39a6af0b-6624-4194-b9d5-0c552d903858',
            system: '',
            price: '¥1050.2／1年',
            oldPrice: '¥3500.64/年'
          },
