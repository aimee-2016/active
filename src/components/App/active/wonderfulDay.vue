    ...
    <div v-show="!winningRecordShow">
        ...
        <div class="w_shoping" ref="shoping">
             ...
             <p class="w_pFont">爆款高配 限时特惠</p>
              ...
              <div>
                  ...
                  <p style="color:#222222;font-size:16px;">云服务器（1核1G）免费体验，最高可用152小时 <a class="w_span" :href="'/activity/zero/'" target="_blank">立即领取</a></p>
                  <div class="w_host">
            ...
            <div>
                ...
                <p style="color:#222222;font-size:16px;">GPU云服务器（16核64G P40显卡）免费体验，最高可用3小时 <a class="w_span" :href="'/activity/zero/'" target="_blank">立即领取</a></p>
        ...
        <div class="w_other">
            ...
            <div>
                ...
                <p style="color:#222222;font-size:16px;">对象存储（100G存储包+100G下行流量）免费体验，最长可用1个月  <a class="w_span" :href="'/activity/zero/'" target="_blank">立即领取</a></p>
                <div class="w_host">
            ...
            <div>
                ...
                <p style="color:#222222;font-size:16px;">云数据库（1核1G）免费体验，最高可用97小时   <a class="w_span" :href="'/activity/zero/'" target="_blank">立即领取</a></p>
                <div class="w_host">
            ...
            <div style="margin:0 auto;width:1140px;height:241px;">
                ...
                <p @click="$router.push({path:'activity'})">查看更多精彩活动</p>
                </div>
            </div>
            </div>
        </div>
