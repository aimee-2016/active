<template>
  ...
  <div style="background: #FFF;  line-height: 0;" id="freeAnnual">
    ...
    <div class="top" ref="top">
      ...
      <p>
        遂需缴纳保证金，保证金随时可退
        <span @click="showRules = 'showRules'">活动规则 ></span>
      </p>
    </div>
    <div class="content">
    ...
    <div class="warns">
      <p>
        <b>温馨提示：</b>
        <br />使用期间若到“百度口碑”发布使用体验等相关评论，截图并发送至在线客服，可领取满200减100优惠券。
    ...
    <div class="steps">
      ...
      <ul>
        <li>
          <img
            src="../../../assets/img/active/freeAnnual/un-login.png"
            alt
            v-show="!$store.state.userInfo"
          />
          <img
            src="../../../assets/img/active/freeAnnual/login.png"
            alt
            v-show="$store.state.userInfo"
          />
        </li>
        <li v-for="(item,index) in stepsList">
          <img
            :src="$store.state.authInfo && $store.state.authInfo.status == item.status ? item.unImg : item.img"
            alt
          />
        </li>
      </ul>
    ...
    <div class="sell" ref="sell">
      <div class="sell-header">
        ...
        <p>
          购买时长越长越便宜，年付低至3折
          <span @click="sysRules = 'sysRules'">活动规则></span>
        </p>
      </div>
    </div>
    <div class="content">
      <div class="content-top">
        ...
        <div class="item-choose" v-for="(item,index) in sellList" :key="index">
          <div class="configs" style="background: rgba(245,246,250,1);">
            ...
            <p>
              <b>{{item[0].bandwith}}M</b>
              <span>宽带</span>
            </p>
            <p>
              <b>{{item[0].disksize}}G</b>
              <span>系统盘</span>
            </p>
          </div>
          <Group class="sysChoose">
            ...
            <div class="deposit">
              <div class="deposit-left">
                <p>
                  价格：￥
                  <span v-if="item[0].price">{{item[0].price.toFixed(2)}}</span>
                </p>
                <p>
                  <span v-if="item[0].oldPrice">原价:￥{{item[0].oldPrice.toFixed(2)}}</span>
                </p>
              </div>
      ...
      <div class="item-choose">
        <Group>
          ...
          <popup-picker
            ...
            :data="gpuTempArr"
            :columns="1"
            v-model="gpuData.config"
            show-name
            @on-hide="gpuPriceChange ()"
            v-if="syStemstatus == 2"
          ></popup-picker>
          <popup-picker
            title="选择区域"
            ...
            v-model="server"
            show-name
            @on-hide="serverChange"
          ></popup-picker>
          <popup-picker
            title="带宽"
            :data="bandwidthListAll"
            :columns="1"
            v-model="parameter.bandwidth"
            :show-name="true"
            @on-hide="bandChange"
          ></popup-picker>
          ...
          <div class="deposit">
            <div class="deposit-left">
              <p>
                价格：￥
                <span
                  style="font-size: 24px;color: #e6001b;font-weight: 600;text-decoration:none"
                >{{allPrice}}</span>
              </p>
            </div>
    ...
    <div class="coupon" ref="coupon">
      <div class="coupon-title">
        配置不够用 券券来帮忙
        <p>
          <span @click="couponRules = 'couponRules'">活动规则></span>
        </p>
      </div>
      ...
      <div class="alert">
        ...
        <ul class="content">
          ...
          <li>
            ...
            免费产品中的资源可随时进行升级，升级费用按新睿云标准收费进行收取。
            <br />在各产品免费使用期间，若对免费资源进行了销毁，则视为放弃免费使用权。
            <br />因押金主机为免费产品，暂不支持备案，若您需要备案可执行押金转续费操作，或者购买包年包月主机及IP之后进行备案。
          </li>
          <li>
            <b>活动声明：</b>
    ...
    <div v-transfer-dom>
      <confirm
        ...
        confirm-text="去活动中心"
        onclick="window.open('https://activity.xinruiyun.cn/', '_self')"
        class="comfirm"
      >
    ...
    <div class="userAlert" :class="certify">
      <div class="alert5">
        ...
        <div class="rules">根据国家规定，使用公共互联网需进行实名认证。</div>
        <div class="foot">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      advantages: [
        {
          ...
          title: "性价比高",
          describe:
            "0基础设施建设投入，企业级云产品便捷采购，0门槛上云，专家团队免费在线咨询，享受云网超顶级硬件与超大带宽"
        },
        {
          img: require("../../../assets/img/active/freeAnnual/sjcj.png"),
          title: "数据持久性",
          describe:
            "全场景光纤网络数据存储，超低延迟高吞吐，最高20万级IOPS，SDN网络诊断技术，快速屏蔽网络故障"
        },
        {
          img: require("../../../assets/img/active/freeAnnual/fwws.png"),
          title: "服务完善",
          describe:
            "7*24小时在线客服，80秒客户问题快速响应，7天无理由退款，12年运营商级技术团队为您保驾护航"
        }
      ],
      //弹窗
      inconformity: false,
      ...
      foots: [
        {
          img: require("../../../assets/img/active/home-m/ft-1.png"),
          title: "7x24",
          name: "多渠道服务与支持"
        },
        {
          img: require("../../../assets/img/active/home-m/ft-2.png"),
          title: "意见",
          name: "反馈与投诉建议"
        },
        {
          img: require("../../../assets/img/active/home-m/ft-3.png"),
          title: "1v1",
          name: "一对一专项服务"
        },
        {
          img: require("../../../assets/img/active/home-m/ft-4.png"),
          title: "退款",
          name: "7天无理由退款"
        }
      ],
  ...
  methods: {
    ...
    openOther() {
      window.open(
        "https://koubei.baidu.com/s/510a4f5f6316c2d0f81b3e63bc75b537?fr=search"
      );
    },
    // 获取活动配置
    getActive() {
          ...
          .then(response => {
            if (response.status == 200 && response.data.status == 1) {
              if (response.data.result.flag) {
                axios
                  .get("/activity/createFreevmTemp.do", {
                    params: {
                      vmConfigId: item.id,
                      osType: item.list[1],
      ...
      axios
        .get("activity/getOriginalPrice.do", {
          params: {
            ...
            month:
              index == 0
                ? this.timeValue1[0].split(",")[0]
                : index == 1
                ? this.timeValue2[0].split(",")[0]
                : index == 2
                ? this.timeValue3[0].split(",")[0]
                : this.timeValue4[0].split(",")[0]
          }
        })
        .then(res => {
          if (res.status == 200 && res.data.status == 1) {
    ...
    getConfig() {
      axios
        .get("information/getServiceoffersByZoneId.do", {
          params: {
            zoneId: this.area[0],
            type: "host"
          }
          ...
          if (res.status == 200 && res.data.status == 1) {
            ...
            this.configList1.forEach(item => {
              ...
              resArr.forEach(e => {
                if (
                  e.rootdisktype == "sas" &&
                  e.zoneid == this.area[0] &&
                  e.cpunum == tempinnerConf[0] &&
                  e.memory == tempinnerConf[1]
                ) {
        ...
        .then(res => {
          if (res.status === 200 && res.data.status === 1) {
            ...
            this.configList2.forEach(item => {
              ...
              tempArr.forEach(e => {
                if (
                  e.cpunum == gpuConfTemp[0] &&
                  e.memory == gpuConfTemp[1] &&
                  e.gputype == "NVIDIA_P100"
                ) {
                  this.gpuTempArr.push({
                    name:
                      e.cpunum +
                      "核" +
                      e.memory +
                      ...
                      "*" +
                      e.gputype,
                    value: e.cpunum + "#" + e.memory + "#" + e.gpusize
                  });
                }
              });
            });
    ...
    getBrand() {
      axios
        .post("device/queryIpPrice.do", {
          brand: this.parameter.bandwidth[0],
          timeType: this.parameter.defaultUse[0] >= 12 ? "year" : "month",
          timeValue:
            this.parameter.defaultUse[0] >= 12
              ? this.parameter.defaultUse[0] / 12
              : this.parameter.defaultUse[0],
          zoneId: this.server[0]
        })
        .then(res => {
          if (res.status == 200 && res.data.status == 1) {
    ...
    getDiskSizePrice() {
      axios
        .post("device/QueryBillingPrice.do", {
          cpuNum: "0",
        ...
        .then(res => {
          if (res.status == 200 && res.data.status == 1) {
            ...
            if (this.syStemstatus == 1) {
              this.allPrice = (
                (res.data.cost + this.serverData.defalutPrice) *
                this.buyNums
              ).toFixed(2);
            } else {
              this.allPrice = (
                (res.data.cost + this.gpuData.defalutPrice) *
                this.buyNums
              ).toFixed(2);
            }
          }
    ...
    getPrice() {
      ...
      axios
        .post("device/QueryBillingPrice.do", {
          cpuNum:
            this.syStemstatus == 1
              ? this.serverData.config[0].split("#")[0]
              : this.gpuData.config[0].split("#")[0],
          diskSize:
            this.syStemstatus == 1
              ? this.serverData.originalDiskSize
              : this.gpuData.originalDiskSize,
          diskType: "ssd",
          gpu: this.syStemstatus == 2 ? "100" : "",
          gpuSize:
            this.syStemstatus == 2 ? this.gpuData.config[0].split("#")[2] : "",
          memory:
            this.syStemstatus == 1
              ? this.serverData.config[0].split("#")[1]
              : this.gpuData.config[0].split("#")[1],
          timeType: this.parameter.defaultUse[0] >= 12 ? "year" : "month",
          timeValue:
            this.parameter.defaultUse[0] >= 12
              ? this.parameter.defaultUse[0] / 12
        ...
        .then(res => {
          if (res.status == 200 && res.data.status == 1) {
            if (this.syStemstatus == 1) {
              ...
              this.allPrice = (
                this.serverData.defalutPrice * this.buyNums
              ).toFixed(2);
              this.originalPrice = this.serverData.defalutPrice;
              this.allPrice = (
                parseFloat(this.allPrice) +
                parseFloat(this.diskSizePrice) * this.buyNums
              ).toFixed(2);
            } else {
              this.gpuData.defalutPrice = res.data.cost + this.brandPrice;
              this.allPrice = (
                this.gpuData.defalutPrice * this.buyNums
              ).toFixed(2);
    ...
    oneBuy() {
      if (this.$store.state.userInfo == null) {
        ...
        if (this.syStemstatus == 1) {
          axios
            .get("information/deployVirtualMachine.do", {
              params: {
                zoneId: this.server[0],
          ...
          // GPU服务器
          axios
            .get("gpuserver/createGpuServer.do", {
              params: {
                zoneId: this.server[0],
                templateId: this.gpuData.defaultSys[1],
                bandWidth: this.parameter.bandwidth[0],
      ...
      .then(res => {
        if (res.status == 200 && res.data.status == 1) {
          ...
          datas["2#4#2"].forEach(e => {
            ...
            this.timeList1.push({
              name: `${time1}(${e.discount * 10}折)`,
              value: e.days / 30 + "," + e.discount
            });
          });
        ...
        if (res.status == 200 && res.data.status == 1) {
          ...
          for (let i = 0; i < areaList.length; i++) {
            if (areaList[i].gpuserver === 1) {
              this.gpuList.push({
                name: areaList[i].zonename,
                value: areaList[i].zoneid
              });
            }
...
.banner {
  width: 100%;
  padding-bottom: 25px;
  background: url("../../../assets/img/active/freeAnnual/bannerbg.png")
      no-repeat,
    linear-gradient(180deg, #3b9ff6 0%, #3b9bf1 2%); //url('../../../assets/img/active/freeAnnual/bannerbg.png') no-repeat,
...
.content {
  .content-top {
    ...
    .indexOne {
      background: url("../../../assets/img/active/freeAnnual/head-1.png")
        no-repeat center;
      background-size: cover;
    }
    .indexTwo {
      background: url("../../../assets/img/active/freeAnnual/head-3.png")
        no-repeat center;
      background-size: cover;
    }
    .indexThree {
      background: url("../../../assets/img/active/freeAnnual/head-2.png")
        no-repeat center;
      background-size: cover;
    }
    .item-choose {
...
.coupon {
  ...
  .coupon-box {
    ...
    div {
      ...
      .left {
        background: url("../../../assets/img/active/freeAnnual/left.png")
          no-repeat center;
        background-size: cover;
      }
      .right {
        background: url("../../../assets/img/active/freeAnnual/right.png")
          no-repeat center;
        background-size: cover;
      }
      .btn {
    ...
    p {
      ...
      .icpIcon {
        ...
        &:before {
          ...
          width: 20px;
          height: 20px;
          background: url("../../../assets/img/active/home-m/record.png")
  ...
  .alert5 {
    ...
    .foot {
      button {
        ...
        background: linear-gradient(
          90deg,
          rgba(248, 191, 136, 1) 0%,
          rgba(255, 209, 140, 1) 36%,
          rgba(248, 191, 136, 1) 100%
        );
