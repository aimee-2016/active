  ...
  <div id="bhost">
    ...
    <div id="Pecs" class="ddos">
      ...
      <div style="padding:40px;">
          ...
          <div style="border-bottom: 1px solid #EDEDED;margin-top: 20px;padding-bottom: 20px">
            ...
            <div class="item-wrapper">
              <div style="display: flex">
                ...
                <div>
                  <Radio v-model="publicIP">购买公网IP</Radio>
                </div>
              </div>
            </div>
            ...
            <div class="item-wrapper">
              <div style="display: flex">
                ...
                <div>
                  <div v-for="item in systemConfig" class="zoneItem" :key="item.id"
          ...
          <div>
            <div style="border-bottom: 1px solid #EDEDED;margin-top: 20px;padding-bottom: 20px">
              ...
              <div class="item-wrapper">
                <div style="display: flex">
                  <div>
                    <p class="item-title" style="margin-top:2px;">防护宽带</p>
                  </div>
                  <div>
        ...
        <div v-show="createType=='custom'">
          <div>
            ...
            <div style="border-bottom: 1px solid #EDEDED;margin-top: 20px;padding-bottom: 20px">
              ...
              <div class="item-wrapper">
                <div style="display: flex">
                  <div>
                    <p class="item-title" style="margin-top:5px;">类型</p>
                  </div>
                  <div>
              ...
              <div class="item-wrapper">
                <div style="display: flex">
                  ...
                  <div>
                    <div v-for="(item, index) in mirrorType" class="zoneItem" :key="(index+22)*15"
              ...
              <div class="item-wrapper">
                <div style="display: flex">
                  <div>
                    <p class="item-title" style="margin-top:5px;">存储类型</p>
                  </div>
                  <div>
              ...
              <div class="item-wrapper">
                <div style="display: flex">
                  <div>
                    <p class="item-title" style="margin-top:5px;">系统盘容量</p>
                  </div>
              ...
              <div class="item-wrapper">
                <div style="display: flex">
                  <div>
                    <p class="item-title" style="margin-top:5px;">核心数</p>
                  </div>
              ...
              <div class="item-wrapper">
                <div style="display: flex">
                  <div>
                    <p class="item-title" style="margin-top:5px;">内存</p>
                  </div>
                  <div>
          ...
          <div>
            <div style="border-bottom: 1px solid #EDEDED;margin-top: 20px;padding-bottom: 20px">
              ...
              <div class="item-wrapper">
                <div style="display: flex">
                  <div>
                    <p class="item-title" style="margin-top:2px;">虚拟私有云</p>
                  </div>
                  <div>
              ...
              <div class="item-wrapper">
                <div style="display: flex">
                  <div>
                    <p class="item-title" style="margin-top:2px;"></p>
                  </div>
                  <div>
                    <div class="desInfo">如需使用其他虚拟私有云（VPC），请选择已有虚拟私有云（VPC），也可以自行到<span @click="$router.push('/vpc')">控制台新建</span></div>
                  </div>
                </div>
              </div>
              <div class="item-wrapper">
                <div style="display: flex">
                  <div>
                    <p class="item-title" style="margin-top:2px;">网卡</p>
                  </div>
                  <div>
              ...
              <div class="item-wrapper">
                <div style="display: flex">
                  ...
                  <div>
                    <div class="desInfo">如您有业务需要开通其他端口，您可以 <span @click="$router.push({path:'/firewall'})">新建防火墙</span></div>
                  </div>
                </div>
              </div>
              <!-- 防火墙规则 -->
          ...
          <div>
            <div style="border-bottom: 1px solid #EDEDED;margin-top: 20px;padding-bottom: 20px">
              <h2>云硬盘</h2>
              <!--虚拟私有云-->
              <div v-for="(disk,index) in dataDiskList" :key="(index+16)*19">
                <div class="item-wrapper">
                  <div style="display: flex">
                    <div>
                ...
                <div class="item-wrapper">
                  <div style="display: flex">
                    ...
                    <div style="width:500px;display: flex;align-items:center">
                      ...
                      <InputNumber :max="1000" :min="20" v-model="disk.size" size="large" :step=10 :precision="0"></InputNumber> <!-- @on-blur="changeDiskSize(index,disk.size)"  @on-focus="changeDiskSize(index,disk.size)" -->
                    </div>
                  </div>
                </div>
              </div>
        ...
        <!-- 登录设置 -->
        <div style="margin-top: 20px;border-bottom: 1px solid #EDEDED;padding-bottom: 20px">
          <h2>登录设置</h2>
          <div>
            <div class="item-wrapper">
              <div style="display: flex">
          ...
          <div class="item-wrapper" v-show="timeForm.currentTimeType !== 'current'">
            <div style="display: flex">
              <div>
                <p class="item-title" style="margin-top: 1px">自动续费</p>
              </div>
        ...
        <div>
          <div style="border-bottom: 1px solid #EDEDED;margin-top: 20px;padding-bottom: 20px">
            ...
            <div class="item-wrapper">
              <div style="display: flex">
                <div>
                  <p class="item-title" style="margin-top: 5px;">购买数量</p>
                </div>
                <div class="countmins">
                  <div class="minusbtn" @click="minusCount"></div>
                  <input class="countNum" type="text" maxlength="2" disabled v-model="purchCount"/>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        // 系统配置 需要购买公网ip时
        systemConfig: [
          {kernel: '2', RAM: '4', bandWidth: '5', diskSize: '40', diskType: 'ssd', diskDesc: 'SSD存储'},
          {kernel: '4', RAM: '8', bandWidth: '10', diskSize: '40', diskType: 'ssd', diskDesc: 'SSD存储'},
          {kernel: '4', RAM: '16', bandWidth: '20', diskSize: '40', diskType: 'ssd', diskDesc: 'SSD存储'},
          {kernel: '8', RAM: '16', bandWidth: '20', diskSize: '40', diskType: 'ssd', diskDesc: 'SSD存储'}
        ],
        // 当前选中系统配置
        currentSystem: {kernel: '2', RAM: '4', bandWidth: '5', diskSize: '40', diskType: 'ssd', diskDesc: 'SSD存储'},
        quickProtectList: [
          {name: '60GB', value: 60},
        ...
        quickProtectSecIndex: {name: '60GB', value: 60},
        quickDdosSelectPrice: 0,
        customProtectList: [
          {name: '60GB', value: 60},
          {name: '100GB', value: 100},
          {name: '200GB', value: 200},
    ...
    methods: {
      ...
      addCart() {
        ...
        if (this.createType == 'fast') {
          ...
          prod.cost = this.totalCost/this.purchCount
        }
      ...
      getProtectConfig(){
        axios.post("device/QueryDdosPrice.do", {
          ...
          if (res.status == 200 && res.data.status == 1){
            this.customDdosSelectPrice = res.data.cost
            if(res.data.coupon){
              this.customProtectCoupon = res.data.coupon
            } else {
              this.customProtectCoupon = 0
            }
          }
        })
      },
      ...
      // 购买数量 - 
      minusCount() {
        let tempCountminus = this.purchCount - 1
        if(tempCountminus < 1){
          this.$Message.info('购买数量不能小于1台');
        } else {
          this.purchCount = tempCountminus
        }
      },
      // 购买数量 + 
      addCount() {
        let tempAddCount = this.purchCount + 1
        if(tempAddCount > 10) {
      ...
      // 请求销售数据
      xiaoshouData() {
        this.$http.get('network/getQQCustomerServiceStatus.do').then(res => {
          if(res.status == 200 && res.data.status == 1){
            let tempScales = []
            res.data.xiaoshou.forEach(item => {
              if(item.qqstatus){
                tempScales.push(item)
              }
            })
            if(tempScales.length == 0){
              // 没有在线的销售的时候
              tempScales = res.data.xiaoshou
            }
            this.xiaoshouInfo = tempScales
          }
        })
      },
      // 联系销售
      contactSales() {
        let tempXiaoshou = this.xiaoshouInfo[Math.floor(Math.random()*(this.xiaoshouInfo.length-1))].qqnumber
        window.open('tencent://message/?uin='+tempXiaoshou+'&amp;Site=www.xrcloud.net&amp;Menu=yes')
      }
    },
    computed: {
      // 剩余添加磁盘数量
      ...
      // 快速选购的时候计算价格
      fastCost() {
        return (this.quickDdosHostPrice + this.quickDdosSelectPrice)*this.purchCount
      },
      fastCoupon() {
        return (this.temFastCoupon)*this.purchCount
      },
      info() {
