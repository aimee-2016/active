    ...
    <div id="Peip" style="padding: 30px 40px 40px 40px;">
             ...
             <div class="b-meal">
                 <div class="bm-rg">弹性防护宽带 </div>
                    <div class="item-wrapper" style="width:77%;margin-top:0;">
                        ...
                        <p class="b-font"><a href="https://www.xrcloud.net/support_docs/1JWD4oQgr6_1JWTi9fgP9.html" target="_blank">点击查看弹性防护带宽计费详情</a></p>
                    </div>
             </div>
            <div class="b-meal">
      ...
      <div style="margin-top: 20px">
                <p style="text-align: left;font-size: 14px;color: #2A99F2;cursor: pointer"
                  ><a href="https://www.xrcloud.net/support_docs/1JWD4oQgr6_1JWTi9fgP9.html" target="_blank">查看计价详情</a></p>
