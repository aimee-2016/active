      ...
      <div class="wrapper-form">
        <div class="banner">
          <my-carousel :interval=5000 class="carousel">
            ...
            <my-carousel-item class="carousel-item">
              <div @click="$router.push('/ddosactive/')" class="ddos">
              </div>
            </my-carousel-item>
            <!-- <my-carousel-item class="carousel-item">
        ...
        <div class="loginOrRegister-form">
          ...
          <div class="register-body" v-show="formType === 'register'">
            ...
            <div class="registerSuccess" v-if="registerForm.onStep === 3||registerForm.onStep === 4">
              ...
              <h2>注册成功</h2>
              <p>扫描二维码完成实名认证即可获得<span style="color: #FF9801"> 158元 </span>专属优惠券，还可参加<span style="color: #FF9801;cursor: pointer" @click="$router.push('/changeLoginPasTypefree/')"> 多款云服务器免费领 </span>活动。<span v-show="registerForm.onStep === 4">请联系您的专属客服小牛获取优惠券</span></p>
      ...
      <div class="universal-modal-content-flex">
        <div class="rules">
          <div class="rulesContent">
            <p><strong>本网站（www.xinruiyun.cn）所提供服务是由北京允睿讯通科技有限公司新睿云向本网站注册用户提供的云计算产品和相关服务，
            ...
            <p>
              您理解并认可，本地盘存储使用的是连接到云服务器上的物理硬盘，由于物理硬盘可能出现机器损坏、瑕疵、磁道损坏等机械故障从而无法对数据存储提供充分的可靠保障，因此，本地盘存储不对其上面的数据做可靠性保证；尽管乙方已尽了勤勉、合理最大的努力，但仍然不能保证现有的安全技术措施将使您的数据不受任何形式的损失，您同意乙方不对由此原因造成的本地盘存储上任何数据的丢失、损毁等承担责任。
