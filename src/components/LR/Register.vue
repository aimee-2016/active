        ...
        <div class="loginOrRegister-form">
          ...
          <div class="register-body" v-show="formType === 'register'">
            ...
            <div class="registerSuccess" v-if="registerForm.onStep === 3||registerForm.onStep === 4">
              ...
              <h2>注册成功</h2>
              <p>扫描二维码完成实名认证即可获得<span style="color: #FF9801"> 158元 </span>专属优惠券，还可参加<span style="color: #FF9801;cursor: pointer" @click="$router.push('activity/free/')"> 多款云服务器免费领 </span>活动。<span v-show="registerForm.onStep === 4">请联系您的专属客服小牛获取优惠券</span></p>
