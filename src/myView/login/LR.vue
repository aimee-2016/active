  ...
  <div class="mask">
    <form onsubmit="return false" v-if="T!='protocol'">
      ...
      <div class="register-wrapper" v-show="T=='success'">
        ...
        >
          恭喜您注册成功，现在完成
          <a href="/userCenter">实名认证</a>即可获得156元专属优惠券，还可参加
    ...
    <div v-if="T=='protocol'" class="protocol-wrapper">
      <div class="rulesContent">
        ...
        <p style="margin-top: 30px">
          <strong>
            本网站（www.xrcloud.net）所提供服务是由北京允睿讯通科技有限公司新睿云向本网站注册用户提供的云计算产品和相关服务，
        ...
        <p>
          1.1 北京允睿讯通科技有限公司（以下称“乙方”,网址：www.xrcloud.net）按照本协议的规定及不定期发布的操作规则向用户（以下称“甲方”）提供系列云产品及
          云业务服务（以下简称“ 本服务”）。
        </p>
        <p>
          1.2 甲方须同意: 乙方变更本服务或协议内容的，将在乙方本服务网络平台（www.xrcloud.net）（以下称“服务门户”）上以公告的方式予以公布，无需另行单独通知
